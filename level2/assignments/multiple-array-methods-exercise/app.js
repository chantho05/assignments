// You should use multiple array methods to solve these problems.
//  Don't use `for` loops!

// Using the provided `peopleArray` (bottom of this article), 
...
const overAge = peopleArray.reduce(function(final, current) {
    if (current.age >= 18) {
